...
// Presenational Component. Its job is to present
...
const Coin = React.createClass(
	{
		...
		// Smart functions dont have a pure return (always return same).
		// They have a render method. The render method
		// has the return statement. All rules apply (jsx, single element)
		// render is special. Render is called when its
		// time to put the componenet in the DOM
		render: function(){
			return(
				<div>
